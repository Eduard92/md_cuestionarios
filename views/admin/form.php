            ...
            <uib-tab heading="Cuestionario">
                    ...
                    <div class="form-group">
                        ...
                        <?php else:?>
                            <label>
                                <?='Tabla'?>
                             <input type="hidden" name="tabla" value="1" ng-model="tabla.val"/>
                            </label>
                            <?php endif ?>                           
                        <?php else: ?>

                        <label class="radio-inline">
                                <input type="radio" name="tabla" value="0" ng-model="tabla.val"  />Ninguno
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="tabla" value="1" ng-model="tabla.val" />Tabla
                        </label>
                        <?php endif ?>
